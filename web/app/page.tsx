  ...
  return (
    <div className="min-h-screen w-full bg-white text-neutral-900">
      ...
      <Section kicker="The app" title="Qué es Papunto" wide>
        ...
        {/* 広い画面では画像を右・左・右と振る。
            ⚠️ アスペクト比を固定して object-cover を掛けないこと。元が16:9の
               画像（登録・タスク）は左右が切られ、周りのアイコンが枠外に出る。
               比率は元のまま、幅は列いっぱいに使う */}
      ...
      >
        {/* 「Qué es Papunto」が 01右 / 02左 / 03右 で終わるので、
            ここは左に置いて左右の振れを続ける */}
        {/* 画像を一番大きく見せたい節なので、横に並べず改行して全幅で置く */}
        ...
        <img
          ...
          loading="lazy"
          className="mt-10 w-full rounded-2xl bg-neutral-50"
        />
      </Section>
